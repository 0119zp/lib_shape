...
public class ConstraintLayoutShape extends ConstraintLayout {
    ...
    public ConstraintLayoutShape(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ConstraintLayoutShape(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
